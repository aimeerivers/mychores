...
http://www.mychores.co.uk"
  ...
  def icalendar
    ...
    for task in @teamtasks
      ...
      when 7 then todo.priority = 1 # highest
      when 6 then todo.priority = 2
      when 5 then todo.priority = 4
      when 4 then todo.priority = 5 # medium
      when 3 then todo.priority = 6
      when 2 then todo.priority = 8
      when 1 then todo.priority = 9 # lowest
      end
